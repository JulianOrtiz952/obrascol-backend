...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.WARNING("Eliminando materiales y movimientos de prueba antiguos..."))
        ...
        # 3. Crear Movimientos
        # Se ha eliminado el return y se reconstruyen los movimientos de cero
